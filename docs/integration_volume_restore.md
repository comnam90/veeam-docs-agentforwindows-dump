...
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/agentforwindows/userguide/integration_volume_restore.html"
...
A volume can be restored to another volume that has greater or less space than the size of the volume in the backup. Depending on the amount of free disk space on the target volume, you can select either to shrink or to extend the volume during restore. To learn more, see [Volume Resize](data_restore_with_volume_resize.md).
