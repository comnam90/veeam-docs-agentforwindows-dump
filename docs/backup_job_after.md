...
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/agentforwindows/userguide/backup_job_after.html"
...
* [Create a standalone full backup](backup_standalone_full.md)
* [Create an incremental backup](backup_incremental.md)
* [Create an active full backup](backup_active_full.md)

If some of your data gets lost or corrupted, you can do the following:

* [Recover all computer volumes or specific volumes from the backup](volume_restore.md)
* [Recover individual files and folders from the backup](files_restore.md)
