...
At the Secure Restore step of the wizard, you can instruct Veeam Backup & Replication to perform secure restore — scan restored disk data with antivirus software before restoring the disk. To learn more about secure restore, see the [Secure Restore](https://helpcenter.veeam.com/docs/vbr/userguide/av_scan_about.html?ver=13) section in the Veeam Backup & Replication User Guide.
