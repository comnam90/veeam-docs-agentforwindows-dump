...
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/agentforwindows/userguide/volume_restore_backup.html"
...
2. [For backup repository target] Backups accessible by the user whose credentials are specified at the [Backup Server](volume_restore_vbr.md) step of the wizard:
...
1. [For cloud repository target] Backups accessible by the user whose credentials are specified at the [Credentials](volume_restore_sp.md#creds) step of the wizard:
...
![Step 5. Select Backup](images/ep_volume_restore_backups.webp "Select Backup")
